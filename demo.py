...
from utils.graph_views import build_all_views, print_user_view_example  # noqa: E402
from utils.metrics import recall_ndcg_at_k, topk_items  # noqa: E402
from visualization.plot_tsne import plot_tsne_two_models  # noqa: E402
from visualization.plot_views import plot_pipeline_flowchart, plot_view_degrees  # noqa: E402
...
def main() -> None:
    ...
    flow_out = os.path.join(ROOT, "visualization", "pipeline_flowchart.png")
    plot_pipeline_flowchart(flow_out)
    print("Saved flowchart:", flow_out)

    deg_path = os.path.join(ROOT, "visualization", "view_degrees.png")
    ...
    if args.baseline_ckpt and os.path.isfile(args.baseline_ckpt) and model_b is not None:
        ...
        tsne_out = os.path.join(ROOT, "visualization", "tsne_compare.png")
